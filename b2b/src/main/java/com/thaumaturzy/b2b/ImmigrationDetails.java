...
public class ImmigrationDetails implements java.io.Serializable
{
   ...
   @org.kie.api.definition.type.Label(value = "When Did you enter US")
   private java.util.Date when_Did_you_Enter_US;

   @org.kie.api.definition.type.Label(value = "When Did you Exit Country")
   ...
   @org.kie.api.definition.type.Label(value = "Visa Type")
   private java.util.List<java.lang.String> visa_Type;

   @org.kie.api.definition.type.Label(value = "I-797    Number")
   private java.lang.String i_797_Number;

   @org.kie.api.definition.type.Label(value = "I_797_Valid_From")
   private java.util.Date i_797_Valid_From;

   @org.kie.api.definition.type.Label(value = "I-797 Valid Till")
   private java.util.Date i_797_Valid_to;

   @org.kie.api.definition.type.Label(value = "Visa Number")
